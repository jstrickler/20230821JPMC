...
fist_contents.setParseAction(upper_case_it)  # Call upper_case_it() when targe text found

title_parser = Combine(prefix + fist_contents)  # Complete title is "A Fist Full of" + more text
